...
const Portfolio = () => {
  ...
  return (
    <div
      name="portfolio"
      className="bg-gradient-to-b from-black to-gray-800 w-full text-white h-fit sm:py-10 md:h-screen sm:h-fit"
      // style={{ marginTop: "2rem", marginBottom: "2rem" }}
    >
      <div className="container max-w-screen-lg mx-auto flex flex-col justify-center w-full h-fit">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8 px-12 sm:px-0 h-fit">
            ...
            <div key={id} className="shadow-md shadow-gray-600 rounded-lg">
              ...
              <div className="flex items-center justify-center">
                ...
                <button
                  ...
                  className="w-1/2 px-6 py-3 m-4 duration-200 hover:scale-105"
                  title={!code ? "Link unavailable (Organization Code)" : ""}
                >
                  Code
                </button>
              </div>
